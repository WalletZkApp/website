      ...
      >
        <div className="max-w-7xl p-5 mx-auto">
          <div className="flex flex-col space-y-12 lg:flex-row lg:space-y-0 justify-between">
                  ...
                  return (
                    <Link href={x.href} key={x.href} target="_blank">
                      <div
                        className={`border ${
                          theme === "light" ? "" : "border-gray-700"
                        } hover:translate-y-[5%] hover:brightness-[0.95] transition-all p-3 flex justify-center items-center rounded-full h-[3.5rem] w-[3.5rem] mr-3 mb-5`}
                      >
                        <img src={x.icon} alt="" />
                      </div>
                    </Link>
            ...
            {/* ZK Wallet  */}
            <div>
              <div className="uppercase font-medium tracking-widest text-light-gd">
                {t("ZK Wallet")}
              </div>
            ...
            <div>
              ...
              <div className="uppercase font-medium tracking-widest text-light-gd mt-5">
                {t("Languages")}
              </div>
              <div className="flex flex-wrap items-center lg:grid lg:grid-cols-4 mt-5">
                {languages.map((x) => {
                  return (
                    <Link href={x.href} key={x.flag}>
                      <img
                        className="h-[1.5rem] w-[2rem] rounded-md cursor-pointer hover:translate-y-[-5%] transition-all drop-shadow-md mr-5 mb-5"
                        src={x.flag}
                        alt=""
                      />
                    </Link>
